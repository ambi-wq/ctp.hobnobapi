...
from matching.serializers import LocationSerializer, UserSerializer, InterestedUserProfile, FollowerSerializer, UserSearchSerializer
from userprofile.models import ProfileDetails, UserPreference, Interest
