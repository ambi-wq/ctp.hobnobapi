...
if 'USER' in os.environ:
    print("inside if======")
    DEBUG = False
    ALLOWED_HOSTS = ['api.hobnobco.com', 'hobnobco.com', '15.206.69.139', '65.2.78.121', 'hobnobco.in', 'www.hobnobco.in']
    #ALLOWED_HOSTS = ['*']
else:
    print("inside else======")
    DEBUG = True
    ...
    if os.environ.get('DEV_TYPE') == 'dev_rahul' and os.environ['USER'] == 'ubuntu':
        ...
        DATABASES = {
            'default': {
                ...
                'USER': 'hobnob',
                'PASSWORD': 'vhs1234#!',
                'HOST': 'hobnob.coxbic4sogj4.ap-south-1.rds.amazonaws.com',
                'PORT': '5432',
            }
        }
...
#print("static root", STATIC_ROOT, BASE_DIR, STATICFILES_DIRS)
...
EMAIL_PORT = '587'
EMAIL_HOST_USER = 'b1a502e33c6e39538a9e6a3cf8312066'
EMAIL_HOST_PASSWORD = 'ec6bb832087f52ecf3747a0acdef4d85'
EMAIL_USE_TLS = True


#Added path for localhost
GDAL_LIBRARY_PATH = r'D:\Ambika\Python Workspace\HobNubAPI\venv\Lib\site-packages\osgeo\gdal302.dll'
GEOS_LIBRARY_PATH = r'D:\Ambika\Python Workspace\HobNubAPI\venv\Lib\site-packages\osgeo\geos_c.dll'
